...
6. **Create each Feature** — fill completely, `createJiraIssue` (SCA, `Feature`, `parent: <EPIC-KEY>`), reference the Epic acceptance criteria each covers; record blocking decisions in Open Questions and in `.agents/DECISIONS-NEEDED.md`.
